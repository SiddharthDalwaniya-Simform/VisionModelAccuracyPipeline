...
#
# HOW TO USE:
#   Copy this file to dev.py and fill in the values marked CHANGE_ME.
# ============================================================
...
DB_CAMERA_ID = 0  # CHANGE_ME — camera_id used for dev tests in the database

# --- S3 + AWS ---
S3_BUCKET = "CHANGE_ME"
# The S3 bucket where the dev ML pipeline stores event clips.
